    ...
    <section className="relative pt-40 md:pt-48 pb-20 md:pb-24 px-6 min-h-[90vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        <div className="flex-1 w-full text-left flex flex-col items-start z-10 mt-12 lg:mt-0">
          <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sage-light/30 border border-sage-main/20 mb-6 text-sage-dark font-medium text-sm">
            <span className="live-dot" /> Live Global Weather
          </motion.div>
          
          <motion.h1 variants={itemVariants} className="text-5xl lg:text-7xl font-bold font-display text-sage-dark leading-[1.1] mb-6 tracking-tighter">
            Global Weather<br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sage-dark to-sage-main">
              Prediction at Your Fingertips
            </span>
          </motion.h1>
          
          <motion.p variants={itemVariants} className="text-lg text-sage-dark/80 mb-10 max-w-xl leading-relaxed">
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center gap-4">
            <Link 
              to="/app"
              className="px-8 py-4 text-base font-bold rounded-2xl btn-primary hover:-translate-y-1 inline-flex items-center gap-3 w-full sm:w-auto justify-center shadow-xl shadow-sage-main/20"
            >
            ...
            <a 
              href="#features"
              className="px-8 py-4 text-base font-bold rounded-2xl bg-white hover:bg-sage-bg transition-colors inline-flex items-center gap-3 w-full sm:w-auto justify-center border border-sage-main/20 shadow-sm text-sage-dark hover:-translate-y-1"
            >
              <Sun className="w-6 h-6 text-sage-main" />
              <div className="flex flex-col items-start text-left">
                <span className="text-[10px] uppercase tracking-wider font-medium text-sage-dark/60 leading-none">Explore</span>
